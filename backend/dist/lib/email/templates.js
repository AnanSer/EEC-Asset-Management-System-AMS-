...
exports.renderPasswordResetTemplate = renderPasswordResetTemplate;
exports.renderWelcomeApprovedTemplate = renderWelcomeApprovedTemplate;
exports.renderWelcomeInvitationTemplate = renderWelcomeInvitationTemplate;
/**
 * Generate Email Verification HTML & plain text.
 */
function renderEmailVerificationTemplate({ name, verificationUrl, token, }) {
 ...
 */
function renderPasswordResetTemplate({ name, resetUrl, token, }) {
    const recipientName = name?.trim() || 'EEC Employee';
 ...
 */
function renderWelcomeApprovedTemplate({ name, employeeId, departmentName, role, loginUrl, }) {
    const recipientName = name?.trim() || 'EEC Employee';
 ...
 */
function renderWelcomeInvitationTemplate({ name, employeeId, departmentName, role, resetUrl, }) {
    const recipientName = name?.trim() || 'EEC Employee';
    const subject = 'Welcome to Ethiopian Engineering Corporation Enterprise Asset Management System';
    const html = `
<!DOCTYPE html>
